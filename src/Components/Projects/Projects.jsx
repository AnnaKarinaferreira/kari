    ...
    return (
        <>
            ...
            <Card className="card1">
                <Card.Header  className="textcard">Projeto backend e frontend com react</Card.Header>
                <Card.Body>
                    <Card.Title  className="textcard">Situação de aprendizagem</Card.Title>
            ...
            <Card className="card1">
                <Card.Header className="textcard">Projeto de jogo da memória com JavaScript</Card.Header>
                <Card.Body>
                    <Card.Title  className="textcard">Jogo da memória</Card.Title>
                    <Card.Text  className="textcard">
            ...
            <Card className="card1">
                <Card.Header  className="textcard">Site de portfolio escolar da escola S (Sesi Senai)</Card.Header>
                <Card.Body>
                    <Card.Title  className="textcard">Portfolio escolar</Card.Title>
                    <Card.Text  className="textcard">
            ...
            <Card className="card1">
                <Card.Header  className="textcard">Site para evento escolar "Mundo Senai"</Card.Header>
                <Card.Body>
                    <Card.Title  className="textcard">Projeto escolar</Card.Title>
                    <Card.Text  className="textcard">
